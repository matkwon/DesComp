...
assembly = 'C:\DesComp\Relogio\Assembler\ASM.txt' # Arquivo de entrada de contém o assembly
destinoBIN = 'C:\DesComp\Relogio\Assembler\BIN.txt' # Arquivo de saída que contém o binário formatado para VHDL
