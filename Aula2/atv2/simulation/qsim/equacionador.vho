...
ARCHITECTURE structure OF equacionador IS
...
-- Equation(s):
-- \ULA1|Add0~1_sumout\ = SUM(( !\PC|DOUT\(2) $ (!\SW[6]~input_o\) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~18_cout\ ))
-- \ULA1|Add0~2\ = CARRY(( !\PC|DOUT\(2) $ (!\SW[6]~input_o\) ) + ( \REGA|DOUT\(0) ) + ( \ULA1|Add0~18_cout\ ))
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = (!\PC|DOUT\(0) & (!\PC|DOUT\(1) & !\PC|DOUT\(2)))
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = (!\PC|DOUT\(2)) # ((!\PC|DOUT\(0) & !\PC|DOUT\(1)))
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = !\PC|DOUT\(2) $ (((!\PC|DOUT\(0) & !\PC|DOUT\(1))))
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( !\PC|DOUT\(2) $ (!\SW[7]~input_o\) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( !\PC|DOUT\(2) $ (!\SW[7]~input_o\) ) + ( \REGA|DOUT\(1) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( !\PC|DOUT\(2) $ (!\SW[8]~input_o\) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( !\PC|DOUT\(2) $ (!\SW[8]~input_o\) ) + ( \REGA|DOUT\(2) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ULA1|Add0~13_sumout\ = SUM(( !\PC|DOUT\(2) $ (!\SW[9]~input_o\) ) + ( \REGA|DOUT\(3) ) + ( \ULA1|Add0~10\ ))
